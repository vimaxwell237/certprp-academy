...
import type { AdminJobFilters } from "@/types/operations";

const jobTypeOptions = ["session_reminder_24h", "session_reminder_soon"] as const;
...
export function OperationsJobFilterForm({
  filters
}: {
  ...
  return (
    <form
      className="grid gap-4 rounded-3xl border border-ink/5 bg-white/90 p-5 shadow-soft lg:grid-cols-6"
      method="get"
    >
