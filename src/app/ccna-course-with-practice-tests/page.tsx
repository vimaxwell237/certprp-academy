...
const page = ccnaCommercialPageMap[APP_ROUTES.ccnaCourseWithPracticeTests];
...
export const metadata: Metadata = buildPageMetadata({
  ...
  path: page.route,
  keywords: [
    "CCNA course with practice tests",
    "CCNA course practice tests",
    "CCNA course with labs and tests",
    "CCNA course with explanations"
  ]
});

export default function CcnaCourseWithPracticeTestsPage() {
