...
import { processOperationAutomationAcknowledgementReminders } from "@/features/operations/data/operations-service";
import {
...
export async function POST(request: NextRequest) {
  ...
  try {
    const summary = await processOperationAutomationAcknowledgementReminders(
    ...
    return automationFailureResponse(
      error,
      "Unable to process automation acknowledgement reminders."
    );
  }
}
